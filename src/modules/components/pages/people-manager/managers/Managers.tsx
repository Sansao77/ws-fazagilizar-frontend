...
const Managers:React.FC = () =>{
    return (
        <IonContent>
            <main>
                <DashHeader title='Gestor de Gerentes' breadcrumbs={['Dashboard', 'Gestor de Gerentes']}/>
                <div style={{'width':'100%', 'display':'inline-flex','justifyContent':'end'}}>
                    <DefaultButton text="novo gerente" icon={addOutline} backgroundColor={buttonColors.VERDE_CLARO}/>
                </div>
